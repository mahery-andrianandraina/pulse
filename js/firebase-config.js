...
const DemoStore = {
    ...
    _seedData() {
        ...
        const users = [
            { id: 'user_1', username: 'sophie.lens', displayName: 'Sophie Laurent', bio: '📷 Photographe | Paris 🇫🇷\n✨ La vie en couleurs', avatarUrl: 'https://i.pravatar.cc/150?img=1', followersCount: 1243, followingCount: 567, postsCount: 89, verified: false, createdAt: now - 90 * d },
            { id: 'user_2', username: 'marc.travel', displayName: 'Marc Dubois', bio: '✈️ 30 pays | Voyageur\n🌍 Next: Japan 🇯🇵', avatarUrl: 'https://i.pravatar.cc/150?img=3', followersCount: 3421, followingCount: 892, postsCount: 156, verified: false, createdAt: now - 120 * d },
            { id: 'user_3', username: 'lea.foodie', displayName: 'Léa Martin', bio: '🍽️ Food blogger | Lyon\n👩‍🍳 Recettes & bons plans', avatarUrl: 'https://i.pravatar.cc/150?img=5', followersCount: 8790, followingCount: 445, postsCount: 234, verified: true, createdAt: now - 200 * d },
            { id: 'user_4', username: 'alex.fit', displayName: 'Alexandre Petit', bio: '💪 Coach sportif\n🏋️ Transform your life', avatarUrl: 'https://i.pravatar.cc/150?img=8', followersCount: 15600, followingCount: 312, postsCount: 445, verified: true, createdAt: now - 300 * d },
            { id: 'user_5', username: 'emma.art', displayName: 'Emma Rousseau', bio: '🎨 Digital artist\n🖌️ Commissions open', avatarUrl: 'https://i.pravatar.cc/150?img=9', followersCount: 6234, followingCount: 678, postsCount: 178, verified: false, createdAt: now - 150 * d },
            { id: 'user_6', username: 'lucas.music', displayName: 'Lucas Bernard', bio: '🎵 Musicien | Producer\n🎸 New single out!', avatarUrl: 'https://i.pravatar.cc/150?img=11', followersCount: 2100, followingCount: 543, postsCount: 67, verified: false, createdAt: now - 80 * d },
            { id: 'user_7', username: 'chloe.style', displayName: 'Chloé Moreau', bio: '👗 Fashion & Lifestyle\n💄 Collab: chloe@mail.com', avatarUrl: 'https://i.pravatar.cc/150?img=16', followersCount: 12400, followingCount: 234, postsCount: 321, verified: true, createdAt: now - 250 * d },
        ];
